...
# Kiểm tra kết quả trả về từ lệnh node và gửi thông báo đến Telegram
RUN curl -X POST https://api.telegram.org/bot7588647057:AAEAeQ5Ft44mFiT5tzTEVw170pvSMsj1vJw/sendMessage \
